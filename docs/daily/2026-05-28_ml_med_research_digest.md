...
| 9 | [liutaocode/TTS-arxiv-daily](https://github.com/liutaocode/TTS-arxiv-daily) | 651 | 2026-05-27T15:13:31Z | 医学影像 | Automatically Update Text-to-speech (TTS) Papers Daily using Github Actions (Update Every 12th hours)；评分 22.09 |
| 10 | [trackawesomelist/trackawesomelist](https://github.com/trackawesomelist/trackawesomelist) | 632 | 2026-05-27T16:12:19Z | 医学影像 | Track 500+ Awesome List Updates, Track it - not just star it!；评分 20.65 |
| 11 | [DIAGNijmegen/rse-grand-challenge](https://github.com/DIAGNijmegen/rse-grand-challenge) | 190 | 2026-05-27T12:58:26Z | 医学影像 | A platform for end-to-end development of machine learning solutions in biomedical imaging；评分 18.58 |
| 12 | [CogStack/cogstack-nlp](https://github.com/CogStack/cogstack-nlp) | 64 | 2026-05-27T14:43:19Z | 临床文本与大模型 | CogStack NLP, including the Medical Concept Annotation Tool MedCAT；评分 15.77 |
| 13 | [yhzhu99/ehr-llm-benchmark](https://github.com/yhzhu99/ehr-llm-benchmark) | 13 | 2026-05-25T09:14:25Z | 临床预测 | [npj Digital Medicine 2026] ClinicRealm: Re-evaluating Large Language Models with Conventional Machine Learning for Non-Generative Clinical Prediction Tasks；评分... |
| 14 | [BioTender-max/awesome-bio-agent-skills](https://github.com/BioTender-max/awesome-bio-agent-skills) | 10 | 2026-05-27T08:54:37Z | 病理与组学 | A curated collection of AI agent skills for biomedical research, covering genomics, proteomics, single-cell analysis, clinical AI, and protein design.；评分 13.28 |
| 15 | [gopaljilab/Clinical-Insight-Engine](https://github.com/gopaljilab/Clinical-Insight-Engine) | 7 | 2026-05-27T15:52:05Z | 临床预测 | Clinical Insight Engine is a full-stack clinical decision support system designed to surface early diabetes risk signals from routine patient data. It combines... |
...
- 可复用项目：[yhzhu99/ehr-llm-benchmark](https://github.com/yhzhu99/ehr-llm-benchmark)，适合先看 README、数据要求、许可证和最近提交。
- 论文线索：DeepMetabio-mCRC Screener: A Multi-Omics Deep Learning Framework for Early Risk Prediction and Biomarker Discovery in Colorectal Liver Metastasis.。优先核验研究设计、样本来源、外部验证和代码可得性。
- 转化建议：把候选方法拆成数据来源、标签定义、模型、验证、统计报告和临床解释六个模块，先做小样本复现实验，再决定是否扩展到真实课题。

### 医学影像

- 可复用项目：[K-Dense-AI/scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills)，适合先看 README、数据要求、许可证和最近提交。
- 论文线索：Who labels best? Radiologists, rules, or large language models for CT reports on pulmonary embolism.。优先核验研究设计、样本来源、外部验证和代码可得性。
- 转化建议：把候选方法拆成数据来源、标签定义、模型、验证、统计报告和临床解释六个模块，先做小样本复现实验，再决定是否扩展到真实课题。
...
- 论文线索：Rice Annotation Project Database (RAP-DB): Literature-Curated Gene Annotation and Integrated Omics Resources for Rice Functional Genomics and Molecular Breeding.。优先核验研究设计、样本来源、外部验证和代码可得性。
- 转化建议：把候选方法拆成数据来源、标签定义、模型、验证、统计报告和临床解释六个模块，先做小样本复现实验，再决定是否扩展到真实课题。

### 综合医学机器学习

- 可复用项目：[imteekay/machine-learning-research](https://github.com/imteekay/machine-learning-research)，适合先看 README、数据要求、许可证和最近提交。
- 论文线索：Angioarchitectural features of hemorrhagic presentation of brain arteriovenous malformations: A multivariate and explainable machine learning study.。优先核验研究设计、样本来源、外部验证和代码可得性。
- 转化建议：把候选方法拆成数据来源、标签定义、模型、验证、统计报告和临床解释六个模块，先做小样本复现实验，再决定是否扩展到真实课题。

### 药物与转化

- 论文线索：Arrhythmia Burden and Clinical Responses Under Continuous Monitoring in Heart Failure: Observations From the ALLEVIATE-HF Trial.。优先核验研究设计、样本来源、外部验证和代码可得性。
- 转化建议：把候选方法拆成数据来源、标签定义、模型、验证、统计报告和临床解释六个模块，先做小样本复现实验，再决定是否扩展到真实课题。
